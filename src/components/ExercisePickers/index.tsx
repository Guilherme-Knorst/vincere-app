...
export interface WorkoutPickersProps {
	exercise: ExerciseModel
	width?: string
	height?: string
}

const ExercisePickers: FunctionComponent<WorkoutPickersProps> = ({ exercise }) => {
	const [updatedExercise, setUpdatedExercise] = useState<ExerciseModel>(exercise)

	const addSerie = () => {
		console.log('adicionar')
	}

	const onChangeRepetitions = (data: number) => {
		console.log(data)
	}

	const onChangeWeight = (data: number) => {
		//
	}
...
export default ExercisePickers
